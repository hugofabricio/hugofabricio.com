...
type FieldProps = Required<Pick<TextareaProps, 'fieldSize' | 'borderColor'>>

type WrapperProps = Required<Pick<TextareaProps, 'marginBottom'>>

export const Field = styled.textarea.withConfig({
